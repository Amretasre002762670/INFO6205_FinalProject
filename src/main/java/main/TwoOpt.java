...
public class TwoOpt {
  ...
  private LocalDateTime start;
    ...
    TwoOpt(List<Vertex> vertices, double[][] distances, int secondsToRun) {
    	this.distances = distances;
        this.vertices = vertices;
        this.secondsToRun = secondsToRun / 2; // divide by two as impl has two opt running twice.
    }
   ...
   private List<Vertex> runTwoOpt(boolean twoOptIterationB) {
        ...
        do {
            ...
            System.out.println(currentDistance+ " best distance inside two opt");
...
//        graph = runTwoOpt(false);
   ...
   private double calculateTotalDistance(List<Vertex> path) {
        ...
        //System.out.println(totalDistance+ " total distance best distance inside two opt");
