...
public class TwoOptTest {
	  ...
	  private static final String INPUT_FILENAME = "crimeSample500.csv";
	    ...
	    public void newTourVertices() throws IOException {
	         ...
	         ChristofidesTour twoOptTour = mainProgram.christofidesAlgorithm(INPUT_FILENAME, 2, "twoOpt");
	    ...
	    public void compareDistance() throws IOException {
	            ...
	            ChristofidesTour newChristofidesTour = mainProgram.christofidesAlgorithm(INPUT_FILENAME, 2, "twoOpt");
